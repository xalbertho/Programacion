import sys, cv2
import numpy as np
from PyQt6.QtGui import QMouseEvent, QPixmap, QImage, qRgb, QPainter, QPen, QColor
from PyQt6.QtWidgets import QApplication, QMessageBox, QLabel, QMainWindow, QFileDialog
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        window = uic.load_ui.loadUi("gui.ui", self)
